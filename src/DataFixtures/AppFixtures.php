...
use App\Entity\Director as EntityDirector;
...
class AppFixtures extends Fixture
{
    public function load(ObjectManager $manager): void
    {
        ...
        foreach ($directors as $directorData) {
            ...
            $directorObjects[$directorData['lastName']] = $director;
        }
        ...
        foreach ($movies as $movieData) {   
            ...
            if (isset($directorObjects[$movieData['director']])) {
                $movie->setDirector($directorObjects[$movieData['director']]);
            }
